...
//  Movies
//
//  Created by Temiloluwa Akisanya on 04/01/2024.
//
...
struct CustomTabBar: View {
    ...
    var backgroundColors = [Color("purpleColor"), Color("lightBlue"), Color("pinkColor")]
    var gradientCircle = [Color("cyanColor"), Color("cyanColor").opacity(0.1), Color("cyanColor")]
